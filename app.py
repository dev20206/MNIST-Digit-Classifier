...
BOUNDARYINC = 5
IMAGESAVE = False
MODEL = load_model("C:\\Users\\devv2\\PycharmProjects\\handwritten digit recognition\\model_checkpoints\\handwrittendigit.h5")
PREDICT = True
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONUP:
            ...
            rect_min_y, rect_max_y = max(0, number_ycord[0] - BOUNDARYINC), min(number_ycord[-1] + BOUNDARYINC,
                                                                                WINDOWSIZEY)
            number_xcord = []
            number_ycord = []
